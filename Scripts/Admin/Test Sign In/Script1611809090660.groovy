...
WebUI.setText(findTestObject('Object Repository/Page_Administator Login/input_Login Panel_email'), email)

WebUI.setText(findTestObject('Object Repository/Page_Administator Login/input_Login Panel_password'), password)

WebUI.click(findTestObject('Object Repository/Page_Administator Login/ins_Remember me_iCheck-helper'))
