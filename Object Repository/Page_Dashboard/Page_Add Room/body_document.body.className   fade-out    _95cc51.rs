...
<WebElementEntity>
   ...
   <name>body_document.body.className   fade-out    _95cc51</name>
   <tag></tag>
   <elementGuidId>3b51e3dc-9a8c-4ed2-995c-363f04518caf</elementGuidId>
   <selectorCollection>
      <entry>
         <key>XPATH</key>
         <value>//body</value>
...
if(submitType == &quot;add&quot;){
url = &quot;https://www.phptravels.net/admin/hotels/rooms/add&quot; ;
}else{
url = &quot;https://www.phptravels.net/admin/hotels/rooms/manage/&quot;+room;
}
$.post(url,$(&quot;.room-form&quot;).serialize() , function(response){
if($.trim(response) != &quot;done&quot;){
$(&quot;.output&quot;).html(response);
}else{
window.location.href = &quot;https://www.phptravels.net/supplier/hotels/rooms/&quot;;
}
});
})
})
...
Add Room
      ...
      Translate
            ...
            Room Description
              ...
              Rich Text Editor, roomdescEditor toolbars Source Bold Italic Underline StrikethroughFormatNormalStylesStyles Insert/Remove Numbered List Insert/Remove Bulleted List Decrease Indent Increase Indent Block Quote Image Link Unlink Anchor Table Insert Horizontal Line Insert Special Character Maximize Cut Copy Paste Paste as plain text Paste from Word Undo Redo Find Replace Select All Spell Check As You TypePress ALT 0 for help◢Elements pathbodyp 
//&lt;![CDATA[
window.CKEDITOR_BASEPATH='c_html/application/libraries/Ckeditor.php';
//]]>
...
id(&quot;select2-drop-mask&quot;)Image PropertiesXImage InfoLinkUploadAdvancedURLBrowse ServerAlternative TextWidthHeightLock RatioReset SizeBorderHSpaceVSpaceAlignment &lt;not set> Left RightPreview Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus. Fusce mi pede, tempor id, cursus ac, ullamcorper nec, enim. Sed tortor. Curabitur molestie. Duis velit augue, condimentum at, ultrices a, luctus ut, orci. Donec pellentesque egestas eros. Integer cursus, augue in cursus faucibus, eros pede bibendum sem, in tempus tellus justo quis ligula. Etiam eget tortor. Vestibulum rutrum, est ut placerat elementum, lectus nisl aliquam velit, tempor aliquam eros nunc nonummy metus. In eros metus, gravida a, gravida sed, lobortis id, turpis. Ut ultrices, ipsum at venenatis fringilla, sem nulla lacinia tellus, eget aliquet turpis mauris non enim. Nam turpis. Suspendisse lacinia. Curabitur ac tortor ut ipsum egestas elementum. Nunc imperdiet gravida mauris.URLBrowse ServerTarget &lt;not set> New Window (_blank) Topmost Window (_top) Same Window (_self) Parent Window (_parent)Send it to the ServerSend it to the ServerIdLanguage Direction &lt;not set> Left to Right (LTR) Right to Left (RTL)Language CodeLong Description URLStylesheet ClassesAdvisory TitleStyle◢OKCancel                One-Bedroom ApartmentTwo-Bedroom ApartmentStudio Apartment With Creek ViewExecutive Two-Bedrooms ApartmentDouble or Twin RoomsTriple RoomsSuperior DoubleJunior SuitesClassic Double or Twin RoomsInterconnecting Classic RoomDelux RoomDouble Deluxe RoomsRoyal Platinum SuiteStandard RoomOne-Bedroom ExecutiveStudio PremierExecutive SuiteExtra Bed / ChildPresidential SuiteFamily Room &amp; Twin / Large SuperiorGarden View RoomOcean View RoomClassic Double RoomClassic Single RoomSuperior Single ViewSuperior Park ViewSingleDoubleGuest RoomsAccessible Rooms</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
